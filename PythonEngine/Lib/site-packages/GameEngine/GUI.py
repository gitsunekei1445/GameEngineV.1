...
import sys
sys.path.append("..")
from glfw import init,create_window,poll_events,swap_buffers,window_should_close,terminate,set_window_pos,make_context_current,get_primary_monitor,set_window_monitor
...
if __name__ == '__main__':
    ...
    gui.gui_setFullscreenMode()

    gui.gui_setWindowMode()
